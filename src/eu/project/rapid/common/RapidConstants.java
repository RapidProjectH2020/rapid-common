...
public class RapidConstants {
    ...
    public static final String DEFAULT_SERVER_IP = "80.158.18.98"; // OTC cloud
    public static final int DEFAULT_VM_PORT = 4322;
    public static final int DEFAULT_VM_PORT_SSL = 5322;
    public static final String DEFAULT_DS_IP = DEFAULT_SERVER_IP;
    public static final int DEFAULT_DS_PORT = 9001;
    public static final String DEFAULT_VMM_IP = DEFAULT_SERVER_IP;
    ...
    public static final String DEFAULT_PRIMARY_ANIMATION_SERVER_IP = DEFAULT_SERVER_IP;
